// Package config reads and writes FamilyJourney CLI profiles.
package config
...
const EnvConfig = "FAMILYJOURNEY_CONFIG"
...
type Profile struct {
	...
	FamilyID  any    `json:"family_id,omitempty"`
...
func Path() string {
	...
	return filepath.Join(root, "familyjourney", "config.json")
}
